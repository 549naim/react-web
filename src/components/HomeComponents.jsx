      ...
      <div className=" c1">
        ...
        <div className="pricing-cart">
          <div className="container price-cart">
            <span className="price-head">Our Pricing</span><hr/>
            <div className="price-text">
              <h2 className="cheak-price">Cheak Our <span style={{color: 'blue'}}>Pricing</span> </h2>
...
<div className="section9">
    <div className="container section-7 sec-9">
      <div className="service01">
        <button type="button" className="price-head">TEAM</button>
      </div>
      <div className="cheak-service">
        <h2 className="cheak">Our Hardworking <span className="span1">Team</span></h2>

      </div>
      <div className="pomitus">
        <p>Ut possimus qui ut temporibus culpa velit eveniet modi omnis est adipisci expedita<br/> at voluptas atque
          vitae autem.</p>
      </div>
    </div>
      ...
      <div className="row">
        <div className="box10 col-12 col-sm-6 col-md-3">
          ...
          <div className="team-img">
            ...
            <span className="team-card-icon"><FaFacebookSquare /></span>
            <span className="team-card-icon">< FaInstagram /></span>
            <span className="team-card-icon"><FaLinkedin /></span>
        ...
        <div class="row">
          <div class="form2-box col-8 col-sm-8 col-md-8">
            <div class="mb-3">
              ...
              <input type="text" class="form-control subs-form" id="formGroupExampleInput2" placeholder=""/>

            </div>

          </div>
          <div class="form2-box col-4 col-sm-4 col-md-4">
            <button type="button" class="btn btn-primary foot-btn btn2">Send Message</button>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        ...
        <div class="footer-box col-12 col-sm-6 col-md-3">
          ...
          <div class="useful-link">
            <p><i class="fas fa-chevron-right s-arrow"></i>
              Home</p>
            <p><i class="fas fa-chevron-right s-arrow"></i>
